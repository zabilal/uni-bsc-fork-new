...
const UNI_ADDRESS = '0x8aaef8170d3e661ab09bee9434d50b2e3a5b5d5d'
export const UNI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.XDAI]: new Token(ChainId.XDAI, UNI_ADDRESS, 9, 'UNI', 'Uniswap')
}
...
export const INITIAL_ALLOWED_SLIPPAGE = 1500
